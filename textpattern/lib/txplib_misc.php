 ...
 *
 * This function passes localisation strings from the database to JavaScript.
 *
 ...
 *
 * This function gets the given language from the database and returns the
 * strings as an array.
 *
 ...
 *
 * This function returns different results based on the logged in
 * user's privileges.
 *
 ...
 * Formats image info.
 *
 * This function takes an image data array generated by imageFetchInfo() and
 ...
 *
 * This function gets either a HTTP cookie of the given name prefixed with
 ...
 *
 * This function executes all callback handlers attached to the matched event
 * and step.
 *
 ...
 *
 * This function is used to generate RFC 3986 compliant and pretty
 * ASCII-only URLs.
 *
 ...
 *
 * This function calculates the offset between the server local time and the
 ...
 * Formats a time.
 *
 * This function respects the locale and local timezone, and makes sure the
 ...
 *
 * This function changes the owner of user's assets. It will move articles,
 * files, images and links from one user to another.
 *
 * This function should be run when a user's permissions are taken away,
 * username is renamed or the user is removed from the site.
 *
 ...
 * Updates a user.
 *
 * This function updates a user account's properties. The $user argument is used
 ...
 *
 * On a successful run, this function will trigger a
 * 'user.password_change > done' callback event.
 *
 * @param   string $user     The updated user
 ...
 *
 * On a successful run, this function will trigger a 'user.remove > done'
 * callback event.
 *
 ...
 * Renames a user.
 *
 * On a successful run, this function will trigger a 'user.rename > done'
 * callback event.
 *
 ...
 *
 * On a successful run, this function will trigger a 'user.change_group > done'
 * callback event.
 *
 ...
 *
 * Returns all preference values from the database as an array. This function
 * shouldn't be used to retrieve selected preferences, see get_pref() instead.
 *
 ...
 *
 * This function prefers global system-wide preferences over a user's
 * private preferences.
 *
 ...
 *
 * This function removes preference strings based on the given arguments.
 * Use NULL to omit an argument.
 *
 ...
 *
 * This function searches for matching preference strings based on the
 * given arguments.
 *
 ...
 *
 * This function updates a preference string's properties. $name and $user_name
 ...
 *
 * This function takes an array of raw HTML attributes, and returns a properly
 ...
 *
 * This function populates $stack_article global with the current $thisarticle.
 */
 ...
 *
 * This function populates $thisarticle global with the last article form the
 ...
 *
 * This function takes an admin step and validates it against an array of valid
 * steps. The valid steps array indicates the step's token based session riding
 * protection needs.
 *
 ...
 *
 * If the $step isn't in valid steps, this function returns FALSE, but the
 * request isn't terminated. If the $step is valid and passes CSRF validation,
 * returns TRUE.
 *
